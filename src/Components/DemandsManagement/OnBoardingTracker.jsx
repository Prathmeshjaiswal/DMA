...
import ProfileTracker from "./ProfileTracker.jsx";
      ...
      <div className="p-16">
        <div className="overflow-x-auto rounded-lg border border-gray-200 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-4 m-20 px-2">
            ...
            <button onClick={() => navigate("/ProfileTracker")} className=" bg-gray-300 rounded-md text-gray-800 py-2 px-10 font-medium tracking-wide hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-400">
              Previous
            </button>
