      ...
      {columns
        ...
        .map((col) => {
          ...
          if (col.key === "demandId") {
            ...
            const chipClass =
              "inline-flex w-32  items-center justify-between rounded-md bg-olive-600 pl-5 pr-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-olive-700";
            ...
            return (
              <td key={col.key} className="border-b border-gray-200 px-4 py-3">
                <div className={`${containerClass} transition-all duration-200`}>
                  ...
                  {/* Demand ID chip with tiny eye icon on the right */}
                  <button
                    type="button"
                    onClick={() => onViewRow(row)}
                    className={`${chipClass} transition-all duration-200`}
                    style={{ backgroundColor: "#6b8e23" }}
                    title="View details"
                  >
                    <span className="truncate">{row.demandId}</span>
...
<EyeOutlined/>
                  ...
                  <button
                    ...
                    className="rounded hover:bg-gray-100 active:bg-gray-200 transition"
...
//                   </button>
//
//                   {/* OPEN DETAILS POP INSTEAD OF ROUTING */}
//                   <button
//                     type="button"
//                     onClick={() => onViewRow(row)}
