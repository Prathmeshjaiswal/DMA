...
//       if ((!prev.demandLocation || prev.demandLocation.length === 0) && options?.onshoreLocation?.length) {
//         const puneOpt =
//           options.onshoreLocation.find((o) => o.label?.toLowerCase() === "pune");
...
//               <div>
//                 <label className={`${labelCls} mb-2 block`}>Demand Type</label>
//                 <PillRadios
//                   name="demandType"
...
//                     value={form.karat}
//                     onChange={(val) => setForm((p) => ({ ...p, karat: val }))}
//                   />
//                 </div>
//               </div>
...
//                   <button
//                     type="button"
//                     className={`px-2 py-0.5 rounded border text-xs ${form.locationType === "onshore" ? "bg-gray-900 text-white" : "bg-white "}`}
...
//                   <button
//                     type="button"
//                     className={`px-2 py-0.5 rounded border text-xs ${form.locationType === "offshore" ? "bg-gray-900 text-white" : "bg-white "}`}
