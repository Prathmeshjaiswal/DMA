...
/** Login: Authenticates user, persists auth + role, builds permissions, and redirects to Dashboard. */
export default function Login() {
  // by simran
  const { setIsAuthenticated } = useAuth();
  const { setPerm } = usePermissions();
  ...
  /** onChange: Generic field updater using input 'name' attributes. */
  const onChange = (e) => {
        ...
        >
          ...
          <div className="text-center mb-8">
            <p className="text-lg font-bold">
              ...
              <span style={{ color: COLORS.white }} className="text-xl">
          ...
          <form onSubmit={submitHandler} className="space-y-6">
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = "#d64f37")
              }
              onMouseLeave={(e) =>
