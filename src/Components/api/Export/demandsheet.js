import api from '../client';
 ...
 export async function exportDemandSheet() {
   const res = await api.get('/api/exports/demands/excel', {
     responseType: 'blob',
     headers: {
  ...
  const filename = `Demands${timestamp}.xlsx`;

  //  let filename = 'demands.xlsx';
